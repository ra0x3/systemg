...
- [Kernel Mode](/docs/kernel-mode/system-mode) — system mode and the privilege-drop sequence
- [Configuration](/docs/how-it-works/configuration) — every security option
- [State](/docs/how-it-works/state) — runtime files and their permissions
