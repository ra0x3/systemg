...
[`sysg validate`](/docs/how-it-works/commands/validate) before starting a stack so
config mistakes are caught early with precise, fixable diagnostics.

## See also

- [Commands](/docs/how-it-works/commands) - Full CLI reference
- [`validate`](/docs/how-it-works/commands/validate) - Check a manifest before running it
- [Configuration](/docs/how-it-works/configuration) - Manifest schema
