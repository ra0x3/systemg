...
reading current persisted state while avoiding detailed runtime process
collection per command.
...
5. **Restarts** replace the fixed-port instance; use blue-green slots when an
   application requires zero-downtime updates
...
- [Hello World](/docs/examples/hello-world) - Simple example to get started
- [Orchestrator](/docs/examples/orchestrator) - Multi-agent task execution
