...
error finding ([SG0705](/reference/dialog/codes#sg0705)) — the file is
...
- [`start`](/reference/commands/start) - Launch a validated manifest
- [`status`](/reference/commands/status) - Check services once they're running
