...
Unit mode is for ad-hoc commands you want systemg to manage without writing a
...
systemg stages the command by translating it into a generated version 2
manifest—the common format the central supervisor understands for services and
projects.
...
See [Units](/docs/examples/units) for the complete stage, apply, inspect, and stop
workflow.
...
[`supervisor.xml`](/docs/how-it-works/configuration#supervisor-configuration) to `1`
...
- [`stop`](/docs/how-it-works/commands/stop) - Stop running services
- [`status`](/docs/how-it-works/commands/status) - Check service health
