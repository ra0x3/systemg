...
- a service name that does not exist → [`SG0202`](/docs/how-it-works/dialog/codes#sg0202),
- a bare `-s <name>` that matches a service in more than one project →
  [`SG0006`](/docs/how-it-works/dialog/codes#sg0006) (pass `-p` to choose),
...
- [`status`](/docs/how-it-works/commands/status) - Quick service overview
