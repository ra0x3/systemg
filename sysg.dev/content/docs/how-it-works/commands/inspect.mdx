...
- a service name that does not exist → [`SG0202`](/reference/dialog/codes#sg0202),
- a bare `-s <name>` that matches a service in more than one project →
  [`SG0006`](/reference/dialog/codes#sg0006) (pass `-p` to choose),
...
- [`status`](/reference/commands/status) - Quick service overview
