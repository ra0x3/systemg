...
It refuses with [`SG0602`](/reference/dialog/codes#sg0602) while a supervisor
...
[`purge`](/reference/commands/purge) cannot destroy the record of a migration
still in progress.

## See also

- [`migrate`](/reference/commands/migrate) - Convert a manifest's shape
- [Projects](/docs/how-it-works/projects) - How one supervisor hosts many projects
- [Diagnostics](/reference/dialog) - [`SG0601`](/reference/dialog/codes#sg0601), [`SG0602`](/reference/dialog/codes#sg0602), [`SG0603`](/reference/dialog/codes#sg0603), [`SG0604`](/reference/dialog/codes#sg0604), [`SG0605`](/reference/dialog/codes#sg0605)
