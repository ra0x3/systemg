...
the recycle is refused ([`SG0303`](/docs/how-it-works/dialog/codes#sg0303)) and the
...
returns [`SG0101`](/docs/how-it-works/dialog/codes#sg0101):

<pre>
  <code>
    {"error["}<a href="/docs/how-it-works/dialog/codes#sg0101">SG0101</a>{"]: cron unit `<name>` cannot be restarted directly\n"}
  </code>
</pre>
...
- [`start`](/docs/how-it-works/commands/start) - Launch services
- [`stop`](/docs/how-it-works/commands/stop) - Stop services
