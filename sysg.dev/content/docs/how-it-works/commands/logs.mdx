...
([`SG0019`](/docs/how-it-works/dialog/codes#sg0019)) so you never get the wrong
...
| `logs` (nothing) | refused — [`SG0019`](/docs/how-it-works/dialog/codes#sg0019) |
...
[`SG0021`](/docs/how-it-works/dialog/codes#sg0021). Combining `--supervisor` with a
selector is [`SG0020`](/docs/how-it-works/dialog/codes#sg0020).
</Note>
...
with [`SG0204`](/docs/how-it-works/dialog/codes#sg0204) rather than guessed at.
...
nor `--max-age` is refused with [`SG0017`](/docs/how-it-works/dialog/codes#sg0017).
</Warning>
...
- [`inspect`](/docs/how-it-works/commands/inspect) - View detailed metrics
