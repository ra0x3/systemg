...
no-op: systemg shows [`SG0101`](/docs/how-it-works/dialog/codes#sg0101) and explains
...
- [`logs`](/docs/how-it-works/commands/logs) - View service output
- [`restart`](/docs/how-it-works/commands/restart) - Restart services
