...
- `command_wait_secs`: how long a CLI command waits for the supervisor's reply
  before reporting [SG0111](/docs/how-it-works/dialog/codes#sg0111). `0` waits
...
manifest returns [`SG0301`](/docs/how-it-works/dialog/codes#sg0301) and leaves the
...
[`sysg migrate`](/docs/how-it-works/commands/migrate), which converts the shape and
...
[`sysg migrate`](/docs/how-it-works/commands/migrate).
...
([SG0207](/docs/how-it-works/dialog/codes#sg0207)) — never a partially loaded
manifest — and cyclic includes ([SG0208](/docs/how-it-works/dialog/codes#sg0208))
or includes past the depth/size caps
([SG0209](/docs/how-it-works/dialog/codes#sg0209)) are refused. Include paths
...
[`SG0022`](/docs/how-it-works/dialog/codes#sg0022) (could not reach),
[`SG0023`](/docs/how-it-works/dialog/codes#sg0023) (a probe timed out), or
[`SG0104`](/docs/how-it-works/dialog/codes#sg0104) (ran but reported unhealthy).
</Note>
...
| `pre_start` | string | Command that must exit successfully before starting; its process tree is terminated after the configured supervisor command budget ([`SG0108`](/docs/how-it-works/dialog/codes#sg0108)) |
...
<Note>
  ...
  [`SG0103`](/docs/how-it-works/dialog/codes#sg0103); exceeding the `supervisor.xml`
  `pre_start_secs` budget is [`SG0108`](/docs/how-it-works/dialog/codes#sg0108), and
...
`projects:` map, run [`sysg migrate`](/docs/how-it-works/commands/migrate) — it prints
