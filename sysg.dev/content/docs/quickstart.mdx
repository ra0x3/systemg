...
- [Configure multiple services](/docs/how-it-works/configuration) with dependencies
- [Run services in the background](https://sysg.dev/reference/commands/start#daemon-mode) with `--daemonize`
- [Set up automatic restarts](/docs/how-it-works/configuration#restart_policy) for production
