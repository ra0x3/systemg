...
[SG0721](/how-it-works/dialog/codes#sg0721) at service start. A future release
...
- [SG0721](/how-it-works/dialog/codes#sg0721) — a security key was accepted
...
- [SG0725](/how-it-works/dialog/codes#sg0725) — unknown seccomp profile; the
  only built-in is `baseline-v1`
- [SG0726](/how-it-works/dialog/codes#sg0726) — seccomp is unsupported on this
  CPU architecture
