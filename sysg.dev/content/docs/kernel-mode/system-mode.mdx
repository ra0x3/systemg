...
- [SG0701](/docs/how-it-works/dialog/codes#sg0701) — running as root *without*
  `--sys`: warns that state will land in root's user-mode paths.
- [SG0702](/docs/how-it-works/dialog/codes#sg0702) — system-mode state exists but
  the command targets the user runtime: refuses rather than touch the wrong
  supervisor.
- [SG0704](/docs/how-it-works/dialog/codes#sg0704) — `--sys` without root: refused.
