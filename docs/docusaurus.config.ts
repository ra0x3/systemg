...
const config: Config = {
  title: 'systemg',
  tagline: 'A general-purpose program composer.',
  ...
  organizationName: 'ra0x3', // Usually your GitHub org/user name.
  projectName: 'systemg', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Stonehedge Labs, Inc.`,
    },
    prism: {
