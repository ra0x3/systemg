...
| `-l` | `--lines` | Trailing lines to show. Omit to show the **full** captured log; pass `-l N` for the last N |
...
([`SG0019`](/how-it-works/dialog/codes#sg0019)) so you never get the wrong
...
| `logs` (nothing) | refused — [`SG0019`](/how-it-works/dialog/codes#sg0019) |
...
[`SG0021`](/how-it-works/dialog/codes#sg0021). Combining `--supervisor` with a
selector is [`SG0020`](/how-it-works/dialog/codes#sg0020).
</Note>
...
with [`SG0204`](/how-it-works/dialog/codes#sg0204) rather than guessed at.
...
nor `--max-age` is refused with [`SG0017`](/how-it-works/dialog/codes#sg0017).
</Warning>
