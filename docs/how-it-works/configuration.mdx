...
manifest returns [`SG0301`](/how-it-works/dialog/codes#sg0301) and leaves the
...
([SG0207](/how-it-works/dialog/codes#sg0207)) — never a partially loaded
manifest — and cyclic includes ([SG0208](/how-it-works/dialog/codes#sg0208))
or includes past the depth/size caps
([SG0209](/how-it-works/dialog/codes#sg0209)) are refused. Include paths
...
| `pre_start` | string | Command that must exit successfully before starting; its process tree is terminated after the configured supervisor command budget ([`SG0108`](/how-it-works/dialog/codes#sg0108)) |
...
<Note>
  ...
  [`SG0103`](/how-it-works/dialog/codes#sg0103); exceeding the `supervisor.xml`
  `pre_start_secs` budget is [`SG0108`](/how-it-works/dialog/codes#sg0108), and
