...
reason and service logs; specific failures use SG0102-SG0109 instead.
...
A service's `pre_start` command exceeded its five-minute execution budget.
systemg terminated the command tree and did not launch the service. Restore the
resource the command was waiting for, then start the project again.
