...
Planned — a seccomp filter could not be built or applied; the service is
refused rather than run unprotected.
...
Planned — Landlock was requested but the kernel ABI is unavailable or
insufficient; the service is refused.
