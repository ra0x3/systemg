...
Live upgrades require the same protocol and patch-release line; use the
documented stop-and-upgrade path for an incompatible minor or major release.
...
mutation may own the control plane. Retry after the named operation settles.
