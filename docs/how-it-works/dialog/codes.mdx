...
Live upgrades require a newer target on the same major/minor release line and
the same protocol. Follow the
[stop-and-upgrade path](/installation/upgrading#compatibility) for an
incompatible minor or major release, a downgrade, or the `0.56.0` bootstrap.
