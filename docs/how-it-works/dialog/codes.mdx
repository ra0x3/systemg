...
Planned — container-init is not supported on this platform.

### [SG0712](/how-it-works/dialog/codes#sg0712)

Planned — PID 1 prerequisites are missing (for example `/proc` not mounted).

### [SG0713](/how-it-works/dialog/codes#sg0713)

Planned — PID 1 shutdown incomplete: services survived reverse-order teardown.
